...
//#undef CONFIG_RC2040
#undef CONFIG_AT32UC3A0512

//#define DEBUG
/* Enable to make ^Z dump the inode table for debug */
//Raman: #undef CONFIG_IDUMP
#define CONFIG_IDUMP
...
// Was this earlier: #define MAX_SWAPS   (0) /* for a 2MB swap partition */
